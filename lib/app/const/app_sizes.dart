...
final class Sizes {
  ...
  /// The padding size of 8.0.
  static const double p8 = 8.0;

  /// The padding size of 10.0.
  static const double p10 = 10.0;

  /// The padding size of 12.0.
  static const double p12 = 12.0;

  /// The padding size of 16.0.
  static const double p16 = 16.0;

  /// The padding size of 20.0.
  static const double p20 = 20.0;

  /// The padding size of 24.0.
  static const double p24 = 24.0;

  /// The padding size of 32.0.
  static const double p32 = 32.0;

  /// The padding size of 40.0.
  static const double p40 = 40.0;

  /// The padding size of 48.0.
  static const double p48 = 48.0;

  /// The padding size of 56.0.
  static const double p56 = 56.0;

  /// The padding size of 64.0.
  static const double p64 = 64.0;

  /// The padding size of 72.0.
  static const double p72 = 72.0;

  /// The padding size of 80.0.
  static const double p80 = 80.0;

  /// The padding size of 250.0.
...
final class Gap {
  ...
  /// The height of 10.0.
  static const SizedBox h10 = SizedBox(height: Sizes.p10);
  ...
  /// The height of 250.0.
  static const SizedBox h248 = SizedBox(height: Sizes.p248);
