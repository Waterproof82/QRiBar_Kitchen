...
class SunAndMoon extends StatefulWidget {
  ...
  final List<ImageProvider> assetPaths;
  final int index;

  SunAndMoon({
    super.key,
    this.isDragComplete = false,
    List<ImageProvider>? assetPaths,
    required this.index,
  }) : assetPaths =
           assetPaths ??
           [
             AssetImage(AssetsEnum.sunYellow.path),
             AssetImage(AssetsEnum.sunRed.path),
             AssetImage(AssetsEnum.moonCrescent.path),
           ];

  @override
  State<SunAndMoon> createState() => _SunAndMoonState();
}
    ...
    return AnimatedOpacity(
      ...
      child: RotationTransition(
        ...
        child: Transform.translate(
          ...
          child: Image(
            image: widget.assetPaths.elementAt(index),
            width: 70,
            height: 70,
          ),
        ),
